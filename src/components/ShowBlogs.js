...
render(){
    return (
        <div>
            ...
            <p>Recommendations: </p> 
            <p>{this.props.rest_link === "nothing yet entered"? <p>{this.props.rest_name}</p>:
            <a  className="App-link"
                href = {"https://" + this.props.rest_link}
                target="_blank"
                rel="noopener noreferrer"
            >{this.props.rest_name}</a>}</p>
            <p>{this.props.hotel_link === "nothing yet entered"?<p>{this.props.hotel_name}</p>:
            <a  className="App-link"
                href = {"https://" + this.props.hotel_link}
                target="_blank"
                rel="noopener noreferrer"
            >{this.props.hotel_name}</a>}</p>
            <p>{this.props.attract_link === "nothing yet entered"?<p>{this.props.attract_name}</p>:
            <a  className="App-link"
