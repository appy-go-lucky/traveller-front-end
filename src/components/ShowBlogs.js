    ...
    return (
        <div className="container" id="show">
            <div className="row">
                ...
                <div className="col-md-4 col-12"><b>Restaurant: </b></div>
                <div className="col-md-4 col-12"><b>{this.props.rest_name}</b></div>
                <div className="col-md-4 col-12">{this.props.rest_link === "nothing yet entered"? <div>{this.props.rest_name}</div>:
                <a  className="App-link"
                    href = {"https://" + this.props.rest_link}
                    target="_blank"
                    rel="noopener noreferrer"
                >{this.props.rest_link}</a>}</div>
                <div className="col-md-4 col-12"><b>Hotel: </b></div>
                <div className="col-md-4 col-12"><b>{this.props.hotel_name}</b></div>
                <div className="col-md-4 col-12">{this.props.hotel_link === "nothing yet entered"?<div>{this.props.hotel_name}</div>:
                <a  className="App-link"
                    href = {"https://" + this.props.hotel_link}
                    target="_blank"
                    rel="noopener noreferrer"
                >{this.props.hotel_link}</a>}</div>
                <div className="col-md-4 col-12"><b>Attraction: </b></div>
                <div className="col-md-4 col-12"><b>{this.props.attract_name}</b></div>
                <div className="col-md-4 col-12">{this.props.attract_link === "nothing yet entered"?<div>{this.props.attract_name}</div>:
                <a  className="App-link"
